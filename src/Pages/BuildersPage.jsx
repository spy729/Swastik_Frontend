    ...
    <div>
      ...
      <div className='m-10 mb-[12rem]'>
        ...
        <div className='flex justify-center items-center gap-10'>
                {/* IMCOMPLETE TEAM */}
        <div  className='flex flex-col justify-center gap-5 border-[3px] border-customGrayText rounded-3xl p-5 pr-[3rem]'>
            ...
            <div className='flex flex-col overflow-y-scroll max-h-[500px] gap-10'>
                {/* component banaao */}
                {
                    ...
                    {/* REQUEST */}
        <div  className='flex flex-col justify-center gap-5 border-[3px] max-w-[390px] border-customGrayText rounded-3xl p-5 pr-[2rem]'>
      ...
      <img className='w-full object-contain' src={footer}></img>
    </div>
  )
}
